<template>
    <v-container class="activity-list px-0 ma-0">
        <v-list bg-color="white" dense class="rounded-lg elevation-2">
            ...
            <!-- Aktivitas -->
            <template v-if="device_acivities && device_acivities.length > 0">
                <template v-for="(activity, index) in device_acivities" :key="activity.activity_id">
                        ...
                        <v-expand-transition>
                            <div v-if="expand_index === index" class="px-4 pb-3">
                                <v-row no-gutters>
                                    ...
                                    <v-col cols="6">
                                        <p class="text-caption font-weight-medium mb-1">Before:</p>
                                    ...
                                    <v-col cols="6">
                                        <p class="text-caption font-weight-medium mb-1">After:</p>
                                        <ul class="text-caption">
                    ...
                    <v-divider v-if="index < device_acivities.length - 1" class="mx-4" />
                </template>
            </template>
...
*/
const props = defineProps(["device_acivities"]);
